	...
	print len(Qmsg)
		...
		try:
			...
			for picture in task:
				...
				j += 1   
                		print r.status_code
			video_path = "/tmp/video%s.mp4" % count
			unix_cmd = "ffmpeg -y -framerate 1/1  -i /home/ubuntu/images/img%d.jpg -b:v 3000000 "+video_path
			os.system(unix_cmd)
			...
			k.set_contents_from_filename('/tmp/video%s.mp4' % count)
			k.get_contents_to_filename('/home/ubuntu/images/yourvideo%s.mp4' % count)
